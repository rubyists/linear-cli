...
Not in Ruby's `linear-cli` - `team list`/`project list` show every
team/project in the workspace by default. Favorite the ones you actually
care about, and each list defaults to just those (`--all` shows
